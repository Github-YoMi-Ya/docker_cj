...
# clone projects
RUN cd src && git clone https://github.com/rm-vision-archive/rm_auto_aim --depth=1 && \
    ...
    git clone https://github.com/rm-vision-archive/rm_gimbal_description --depth=1 && \
    git clone https://github.com/rm-vision-archive/rm_serial_driver --depth=1 && \
    git clone https://github.com/rm-vision-archive/rm_vision --depth=1
